<html>
<head>
<title>TE A comps Timetable</title>
</head>
...
<body>
<input type="button"  value="Done" onclick="done()">&nbsp;&nbsp;&nbsp;<input type="button"  value="Save" onclick="saveta2()">
<table border="2px"  height="90%" width=100% cellpadding=5px>
<caption>Computer Engg.</caption>
<caption>TE-A (A2)</caption>
<tr>
<th>Time</th>
<th>Monday</th>
<th>Tuesday</th>
...
<td class="data"><center><?php include 'fetchsubject.php';?><p class="par"></p></center></td>
<td class="data"><center><?php include 'fetchsubject.php';?><p class="par"></p></center></td>
<td class="data"><center><?php include 'fetchsubject.php';?><p class="par"></p></center></td>
<td class="data"><center><?php include 'fetchsubject.php';?><p class="par"></p></center></td>
<td class="data"><center><?php include 'fetchsubject.php';?><p class="par"></p></center></td>
